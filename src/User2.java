...
public class User2 extends JFrame implements ActionListener
{
    ...
    public void init()
    {
        ...
        filesavelocation = "C:\\Users\\dalvi\\OneDrive\\Desktop\\Conference-call-using-UDP-in-Java\\2";
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> {
            User2 conferenceApp3 = new User2();
            conferenceApp3.init();
            conferenceApp3.setSize(450, 200);
            conferenceApp3.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
            conferenceApp3.setVisible(true);
        });
    }
}
