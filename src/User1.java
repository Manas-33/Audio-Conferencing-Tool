...
public class User1 extends JFrame implements ActionListener
{
    ...
    public void init()
    {
        ...
        filesavelocation = "C:\\Users\\dalvi\\OneDrive\\Desktop\\Conference-call-using-UDP-in-Java\\1";
...
//						}
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> {
            User1 conferenceApp2 = new User1();
            conferenceApp2.init();
            conferenceApp2.setSize(450, 200);
            conferenceApp2.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
            conferenceApp2.setVisible(true);
        });
    }
}
