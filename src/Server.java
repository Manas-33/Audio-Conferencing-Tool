...
public class Server extends JFrame implements ActionListener
{
    ...
    public void init()
    {
        ...
        filesavelocation = "C:\\Users\\dalvi\\OneDrive\\Desktop\\Conference-call-using-UDP-in-Java";
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> {
            Server conferenceApp = new Server();
            conferenceApp.init();
            conferenceApp.setSize(450, 200);
            conferenceApp.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
            conferenceApp.setVisible(true);
        });
    }
}
